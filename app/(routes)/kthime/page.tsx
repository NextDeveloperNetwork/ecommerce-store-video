  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-md shadow-lg">
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">2.1 Klienti duhet të bëjë një kërkesë të shkruar për kthim përmes faqes sonë të internetit ose të kontaktojë shërbimin tonë të klientit.
      ...
      <div className="mb-8">
       ...
       5.2 Klientët duhet të rishikojnë rregulloren periodikisht dhe të informohen për ndryshimet e fundit në politikën e kthimeve.</p>
      </div>

      <p className="italic">
        Kjo rregullore ka hyrë në fuqi nga data 18/11/23 dhe do të zbatohet për kthimet e produkteve nga Edi Store.
      </p>
    </div>
  );
};
