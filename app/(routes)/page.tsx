...
const HomePage = async () => {
  ...
  const truncatedAndShuffledProducts = products
    .slice(0, 500)
        ...
        <div className="col-span-1 lg:col-span-9  ">
          <Container>
            ...
            <div className="flex flex-col gap-y-8 mb-2">
              {" "}
              {/* Removed px values to allow natural spacing */}
              <ProductList
                title="Produkte"
                items={truncatedAndShuffledProducts}
              />
            </div>
          </Container>
        </div>
