...
export default function CookieBanner(){
    ...
    return (
        <div className={`my-10 mx-auto max-w-max md:max-w-screen-sm
            ...
            <button className='px5 py2 text-gray-300 rounded-md border gray-900' onClick={() => setCookieConsent(false)}>Decline</button>
            <button className='px5 py2 text-white border gray-900 rounded-lg' onClick={() => setCookieConsent(true)}>Allow Cookies</button>
            </div>   
        </div>
    )}