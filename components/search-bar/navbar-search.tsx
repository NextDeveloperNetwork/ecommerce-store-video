      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="relative px-1">
        ...
        <div className="flex items-center">
          <input
            type="search"
            id="default-search"
            className="w-full  sm:w-72 p-2 pl-14 text-base text-black border  bg-white rounded-full focus:ring-1 focus:ring-gray-200 focus:border-gray-400 outline-none"
            placeholder="Search..."
