...
const useMessageW = (): MessageHook => {
  ...
  const addItemToWapp = (item: any) => {
    ...
    const messengerConversationLink = `https://wa.me/+355692711177/?ref=INTENCION&messaging_source=source%3Apages%3Amessage_shortlink&source_id=1441792&recurring_notification=0&text=Porosit%20kete%20artikull:%0AArt:%20${item.name}%0AArticle%20link:%20${articleLink}`;
