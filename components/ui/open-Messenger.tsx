...
const useMessage = (): MessageHook => {
  ...
  const addItemToMessenger = (item: Item) => {
    ...
    const messengerConversationLink = `http://m.me/61553134485424/?ref=INTENCION&messaging_source=source%3Apages%3Amessage_shortlink&source_id=1441792&recurring_notification=0&text=Porosit%20kete%20artikull:%0AArtikull:%20${item.name}%0AArticle%20link:%20${articleLink}`;
